...
import 'package:testing_adapty/bg_ui.dart';
  ...
  Future<void> _showErrorDialog(
    ...
    return showCupertinoDialog(
      ...
      builder: (ctx) => CupertinoAlertDialog(
        title: Text(title),
        content: Column(
          children: [Text(message), if (details != null) Text(details)],
        ),
        actions: [
          CupertinoButton(
            child: const Text('OK'),
                ...
                return CupertinoTabView(
                  builder: (context) {
                    return CupertinoPageScaffold(
                      child: MainScreen(
                        adaptyErrorCallback: (e) => _showErrorDialog(
                          context,
                          'Error code ${e.code}!',
                          e.message,
                          e.detail,
                        ),
                        customErrorCallback: (e) => _showErrorDialog(
                          context,
                          'Unknown error!',
                          e.toString(),
                          null,
